...
### 和babel-loader搭配使用
如果项目中已经使用 babel-loader，你也可以选择使用 @babel/preset-typescript 规则集，将 ts 转换为 es6，借助 babel-loader 完成 JavaScript 与 TypeScript 的转码工作。
...
接下来，我们使用 Webpack、Vue3、Express、@vue/server-renderer 框架搭建一套完备的 Vue SSR 引用，[代码地址](https://github.com/1f606/webpack-book-samples/tree/main/5-2_use-ssr)。
